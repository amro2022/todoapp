    ...
    <div class="container">
        <div class="row">
            <div class="col-8 mx-auto">
                <form action="handlers/store-data.php" method="POST" class="form border p-2 my-5">
                    ...
                    <tbody>
                        <?php while($row = mysqli_fetch_assoc($result)):?>
                            ...
                            <tr>
                                ...
                                <td><?= $row['title'];?></td>
                                <td>
                                    <a href="handlers/delete-data.php?id=<?= $row['id']; ?>" class="btn btn-danger"><i class="fa-solid fa-trash-can"></i> </a>
